...
import ResearchLab from '../views/ResearchLab.vue'
import HypothesisDetail from '../views/HypothesisDetail.vue'

const routes = [
  { path: '/', name: 'Home', component: Home },
  { path: '/research', name: 'ResearchLab', component: ResearchLab },
  { path: '/research/hypothesis/:hypothesisId', name: 'HypothesisDetail', component: HypothesisDetail, props: true },
